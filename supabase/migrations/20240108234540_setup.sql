...
AS $$
DECLARE
  project_url TEXT := 'https://vcrlnmgmxzjlekkejqgs.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZjcmxubWdteHpqbGVra2VqcWdzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNDQ5ODM1MSwiZXhwIjoyMDMwMDc0MzUxfQ.TOTatG_0C_ixn0mXWWCrue9qro7DCMRYqk3YFksIS6c'; -- full access needed for http request to storage
